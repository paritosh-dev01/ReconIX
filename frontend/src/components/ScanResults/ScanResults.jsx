      ...
      <main className="scan-results-main">
        ...
        <section className="scan-results-header">
          ...
          <div className="results-actions">
            ...
            <button className="secondary-action">⇩ Export⌄</button>
            <button className="download-action">↓ Download Report⌄</button>
          </div>
        </section>
          ...
          <div className="results-card security-score-card">
            ...
            <div className="score-content">
              ...
              <div className="score-details">
                <div className="score-grade">B</div>
                <strong>Very Good</strong>
                <p>Your security posture is strong. Keep up the good work!</p>
              </div>
            </div>
        ...
        <section className="results-lower-grid">
          ...
          <div className="results-card affected-card">
            ...
            <a href="#" className="view-link">View all assets →</a>
          </div>
