...
export default function Reports() {
  ...
  const handleSubmitGenerate = (e) => {
    ...
    const reportTitle = formName.trim() || `${formType} Security Assessment`;
    const newReport = {
      id: Date.now(),
      name: reportTitle,
      scan: formScan,
      ...
      status: "Ready",
      format: formFormat,
      size: formFormat === "JSON" ? "420 KB" : formFormat === "CSV" ? "180 KB" : "2.8 MB",
  ...
  const filteredReports = reports.filter((item) => {
    const matchesSearch =
      ...
      item.scan.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  <div className="reports-system-card">
    ...
    <div className="reports-system-status">
      ...
      <main className="reports-main">
        ...
        <div className="reports-header">
          <div className="reports-title-area">
            <h1>Reports</h1>
            <p>Generate, manage and download security assessment reports.</p>
          </div>
          ...
          >
            ...
            <form onSubmit={handleSubmitGenerate}>
                ...
                <div className="reports-field-row">
                  <div className="reports-field">
                    ...
                    >
                      ...
                      <option value="Vulnerability">Vulnerability Audit</option>
                      <option value="Infrastructure">Infrastructure Recon</option>
                ...
                <div className="reports-field">
                  ...
                  <div className="format-selector">
                    {["PDF", "CSV", "JSON"].map((fmt) => (
                      ...
                      >
                        <span className="format-title">{fmt}</span>
              ...
              <div className="reports-modal-footer">
                ...
                <button type="submit" className="reports-btn-primary">
                  Generate Report
                </button>
              </div>
            </form>
      ...
      {/* =========================================
          MODAL: REPORT PREVIEW (VIEW ACTION)
      ========================================= */}
          ...
          >
            <div className="reports-modal-header">
              <div>
                ...
                <h2>{selectedReportPreview.name}</h2>
                <p>Generated: {selectedReportPreview.generated}</p>
              </div>
              <button
                className="reports-modal-close"
                onClick={() => setSelectedReportPreview(null)}
            ...
            <div className="reports-modal-body">
              <div className="preview-meta-grid">
                <div className="preview-meta-item">
                  ...
                  <strong>{selectedReportPreview.scan}</strong>
                </div>
                <div className="preview-meta-item">
                  <span>Type</span>
                  <strong>{selectedReportPreview.type}</strong>
                </div>
                <div className="preview-meta-item">
                  <span>Findings</span>
              ...
              <div className="preview-section">
                ...
                <p>
                  ...
                  <b>{selectedReportPreview.scan}</b> to identify misconfigurations,
                  exploitable surface areas, and compliance vulnerabilities. All
                  findings have been cataloged with CVE correlations and
              ...
              <div className="preview-section">
                ...
                <div className="preview-breakdown">
                  <div className="breakdown-bar">
                    <span className="bar-critical" style={{ width: "25%" }}></span>
                    <span className="bar-high" style={{ width: "35%" }}></span>
                    <span className="bar-medium" style={{ width: "25%" }}></span>
                    <span className="bar-low" style={{ width: "15%" }}></span>
                  </div>
                  <div className="breakdown-legend">
                    <span><i className="crit"></i> Critical (2)</span>
                    <span><i className="high"></i> High (5)</span>
                    <span><i className="med"></i> Medium (8)</span>
                    <span><i className="low"></i> Low (9)</span>
                  </div>
                </div>
              </div>
            </div>
